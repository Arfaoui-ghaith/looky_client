...
function BarberShopWorkingHoursForm() {
  ...
  const [updateBarberPassword, { isLoading }] =
      ...
      <div className="col-lg-10 mt-3 mx-auto">
        <div className="row">
          <div className="col-md-4">
            <div className="form-floating mb-3">
              <select
                ...
                onClick={(e) => change("serviceId", e.target.value)}
              >
          ...
          <div className="col-md-2">
            ...
            <InputSwitch
              inputId="switch1"
              checked={data[selectedDay].isClosed}
              onChange={() => changeData()}
            />
          </div>
        </div>
