...
export default function AppointmentsTable({ isLoading, appointments }) {
  ...
  const [updateAppointment, { isLoading: appointmentLoading }] =
  ...
  const footerConfirmContent = (
    <div>
      <Btn
        label="No"
        icon="pi pi-times"
        onClick={() => setVisibleConfirmDialog(false)}
  ...
  const footerCancelContent = (
    <div>
      ...
      <Btn
        icon="pi pi-check"
        onClick={() => updateAppointmentStatus("refused")}
      >
        {appointmentLoading ? <BeatLoader color="#fff" size={10} /> : "Yes"}
      </Btn>
    </div>
  ...
  const footerDisplayContent = (
    <div>
      <Btn
        label="No"
        onClick={() => setVisibleDisplayDialog(false)}
        className="p-button-text"
      />
    </div>
  );
          ...
          <div className="relative flex justify-end items-center gap-2">
            <Dropdown className="border: none;">
              ...
              {appointment.status === "waiting" ? (
                ...
                <DropdownMenu>
                  <DropdownItem
                    key={appointment.id + "display"}
                    onClick={() => {
                      dispatch(setAppointment({ ...appointment }));
                      setVisibleDisplayDialog(true);
                    }}
                  >
                    View Details
                  </DropdownItem>
    ...
    <div className="m-5">
      ...
      <div className="card flex justify-content-center">
        ...
        >
          <p className="m-0" style={{ color: "#fff" }}>
            Do you want to <strong style={{ color: "green" }}>confirm</strong>{" "}
            this appointment ?
          </p>
          ...
          <p className="m-2" style={{ color: "#fff" }}>
            ...
            : {new Date(appointment?.date).getUTCHours()}h
      ...
      <div className="card flex justify-content-center">
        <Dialog
          ...
          footer={footerCancelContent}
        >
          <p className="m-0" style={{ color: "#fff" }}>
            Do you want to <strong style={{ color: "#EB1616" }}>cancel</strong>{" "}
            this appointment ?
          </p>
      ...
      <div className="card flex justify-content-center">
        <Dialog
          ...
          visible={visibleDisplayDialog}
          style={{ width: "30vw" }}
          onHide={() => setVisibleDisplayDialog(false)}
          footer={footerDisplayContent}
        >
          <p className="m-2" style={{ color: "#fff" }}>
            <strong className="mx-auto" style={{ color: "#EB1616" }}>
              Customer
