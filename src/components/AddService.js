    ...
    >
          ...
          <div className="">
            ...
            <div className="d-flex align-items-center justify-content-between mb-3">
              <div className="form-floating me-2 mt-3">
                <InputNumber
                  placeholder="Price"
                  onValueChange={(e) => change("price", e.target.value)}
                  mode="currency"
                  currency="TND"
                />
              </div>
              <div className="form-floating mt-4">
                <div className="p-inputgroup mb-2">
                  <InputNumber
                    placeholder="Duration in mn"
                    onValueChange={(e) => change("duration", e.target.value)}
                    min={0}
                  />
                </div>
              </div>
        ...
        {isSuccess ? (
          <div>
            <h1 className="text-uppercase mb-4">
              Upload your service gallery here!
            </h1>
            <p>
              Note: the first uploaded image will be the primary one for this
              service.
            </p>
            <MultiUploader
      ...
      <div className="d-flex align-items-center justify-content-between mb-3">
        {!isSuccess ? (
          <button
            type="submit"
            className="btn-primary py-3 w-90 mb-2"
            onClick={(e) => submitAddService(e)}
          >
