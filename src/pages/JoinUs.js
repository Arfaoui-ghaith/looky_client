        ...
        >
          <div className="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-7">
            <h1 style={{ "text-align": "center" }}>
              <span className="text-primary">Join</span> as a customer or barber
              shop
            </h1>
            <div className="d-flex align-items-center justify-content-around ">
              <div
                className="col-lg-6 col-md-5 wow fadeInUp m-2"
                data-wow-delay="0.1s"
                style={{
                  visibility: "visible",
              ...
              >
                <div className="service-item position-relative overflow-hidden bg-secondary d-flex h-100 p-5 ps-0">
                  ...
                  <Link
                    to="/sign-up/customer"
                    className="btn btn-square rounded-0"
                  >
              ...
              <div
                className="col-lg-6 col-md-6 wow fadeInUp m-2"
                data-wow-delay="0.1s"
                style={{
                  visibility: "visible",
                  "animation-delay": "0.1s",
